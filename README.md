...
<ul>
  ...
  </li>Here **image of the person is not stored in the database ** , **only embedding of the image  is being stored for verification, so user dont need to worry about their images getting leaked or misused**</li>
